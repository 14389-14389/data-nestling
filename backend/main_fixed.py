...
MONGODB_URI = "mongodb+srv://kevinmuli:Alfaromeo001@donpablo001.x7ree.mongodb.net/data_nestling?retryWrites=true&w=majority"
DATABASE_NAME = "data_nestling"
PORT = 8000

print("🚀 Starting Data Nestling Backend with Hardcoded Configuration")
print(f"🔧 Configuration:")
print(f"   - MONGODB_URI: Set ({len(MONGODB_URI)} characters)")
