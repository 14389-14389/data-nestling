...
export const Sidebar = ({ activeCategory, onCategoryChange, fileStats }: SidebarProps) => {
  // Use real file statistics instead of hardcoded numbers
  const categories: Category[] = [
    { id: "all", name: "All Files", icon: Folder, count: fileStats.total },
    { id: "documents", name: "Documents", icon: FileText, count: fileStats.documents, color: "text-blue-500" },
    { id: "images", name: "Images", icon: Image, count: fileStats.images, color: "text-green-500" },
    { id: "videos", name: "Videos", icon: Video, count: fileStats.videos, color: "text-purple-500" },
    { id: "audio", name: "Audio", icon: Music, count: fileStats.audio, color: "text-pink-500" },
    { id: "archives", name: "Archives", icon: Archive, count: fileStats.archives, color: "text-orange-500" },
  ];

  const quickAccess: Category[] = [
    { id: "starred", name: "Starred", icon: Star, count: fileStats.starred },
    { id: "recent", name: "Recent", icon: Clock, count: 8 }, // Keep recent hardcoded for now
    { id: "trash", name: "Trash", icon: Trash2, count: 0 }, // Keep trash hardcoded for now
  ];
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between px-3 mb-3">
            ...
            <Tooltip>
              ...
              <TooltipContent>
                <p>Click to filter files by type</p>
              </TooltipContent>
            </Tooltip>
          </div>
        ...
        <div className="space-y-1 pt-4 border-t">
          <div className="flex items-center justify-between px-3 mb-3">
            ...
            <Tooltip>
              ...
              <TooltipContent>
                <p>Quick links to special folders</p>
              </TooltipContent>
            </Tooltip>
          </div>
